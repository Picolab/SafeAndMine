ruleset io.picolabs.safeandmine {
  ...
  rule send_registry_request {
    ...
    event:send({"eci": ent:registry_eci.defaultsTo("registryEciGoesHere"), "domain": "safeandmine", "type": "register_tag", "attrs" : { "tagID" : tagID, "DID" : channel, "domain" : domain } });
  ...
  rule deregister_tag {
    ...
    event:send({"eci": ent:registry_eci.defaultsTo("registryEciGoesHere"), "domain": "safeandmine", "type": "deregister_tag", "attrs" : { "tagID" : tagToDelete, "domain" : domain } });
